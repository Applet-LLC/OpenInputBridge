...
// Scheduled Task that reacts to the 4656/4663 events that feature's SACL causes Windows to emit;
// it does not set up any auditing itself.
//
...
//   2. A Scheduled Task is registered with a custom event trigger on Security-log event IDs
//      4656/4663 (any object — the exact \\.\interceptionNN device is checked by
